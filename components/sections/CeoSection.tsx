...
export default function CeoSection() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 md:px-8 pb-14 md:pb-20 lg:pb-32 bg-white">
      <div className="">
        {/* ── HEADING ──────────────────────────────────────── */}
        <AnimateOnScroll type="fade-up">
          <div className="max-w-2xl mx-auto text-center mb-10 md:mb-16">
            ...
            <p className="text-brand-muted text-sm leading-relaxed">
              ...
              skilled negotiations, and other essential professional services
              are included in the transparent house price.
            </p>
          </div>
        </AnimateOnScroll>
