const siteConfig = {
  ...
  contact: {
    ...
    email: "hello@prestigeproperties.eg",
    address: "90 Street, New Cairo, Cairo, Egypt",
  ...
  social: [
    {
      name: "instagram",
      href: "https://instagram.com/prestigeproperties",
